...
syn match   cysLabel	"[a-zA-Z_][a-zA-Z0-9_]*\:"
...
syn match	cysNumber	display contained "[^a-zA-Z_]\d\+"
...
syn keyword	cysRepeat	while for foreach do def
syn keyword cysConst	null true false	
syn keyword cysType		int real utf8 ascii void float
syn keyword cysType		int8 int32 uint8 uint32 double bool
